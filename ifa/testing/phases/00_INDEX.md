...
| 09 | [09_synthetic_coverage.md](09_synthetic_coverage.md) | Synthetic IR generator for splitter-stage coverage; V deletion plan; Phase D promotes L2 builders to library-level for pyc reuse | [IFA.md](../../IFA.md), [issues/003](../../issues/closed/003-fa-converge-determinism.md) | Phases A+B done; C ready; D queued | — |
